...
from api.detection_controllercontroller.detection_controller import detection_bp
import os
...
def create_app():
    ...
    # PostgreSQL Config
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://reshu890@localhost:5432/detection_db'
